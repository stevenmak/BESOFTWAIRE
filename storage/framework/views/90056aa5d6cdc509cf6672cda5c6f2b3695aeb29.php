<?php $__env->startSection('title', 'AfficherTaches'); ?>
            ...
            <div class="card-body">
                ...
                <div class="row row-sm">
                        ...
                        <div class="form-group col-12 list-group-item">
                            <center><h4><?php echo e($taches->designation); ?></h4></center>
                        </div>
                            <div class="form-group col-6 list-group-item">
                                <em><label>Déscription: </label><?php echo e($taches->description); ?></em>
                            </div>
                        <div class="form-group col-6 list-group-item">
                            <label>Date du début: </label><?php echo e($taches->dateDebut); ?>

                        </div>
                        <div class="form-group col-6 list-group-item">
                            <label>Date de fin: </label>
                            <?php echo e($taches->dateFin); ?>

                        </div>
                        <div class="form-group col-6 list-group-item">
                            <label>Estimation: </label>
                            <?php echo e($taches->depenseEstimerTache); ?>

                        </div>
                        <div class="form-group col-6 list-group-item">
                            <label>Priorité de la tache: </label>
                            <?php echo e($taches->priorite); ?>

                        </div>
                        <div class="form-group col-6 list-group-item">
                            <label>Avancement: </label>
                        <?php echo e($taches->avancement); ?>

                        </div>
                        <div class="form-group col-6 list-group-item">
                            <label>Etape: </label>
                            <?php echo e($etapes =App\Etapes::select('nomEtape')->where('id', $taches->etape_id)->value('nomEtape')); ?>
                        ...
                        <div class="text-muted text-sm text-center list-group-item">
                            ...
                            <em>
                                <?php echo e($users=App\User::select('name')->where('id',$taches->users_id)->value('name')); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\BESOFTWAIRE\resources\views/taches/show.blade.php ENDPATH**/ ?>