<?php $__env->startSection('title', 'CeerDepartement'); ?>
    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <?php endif; ?>
                <?php echo Form::open(array('route' => 'departements.store','method'=>'POST')); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\BESOFTWAIRE\resources\views/departements/create.blade.php ENDPATH**/ ?>