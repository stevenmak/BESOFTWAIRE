<?php $__env->startSection('title', 'AfficherClient'); ?>
            ...
            <div class="card-body">
                <div class="row row-sm">
                    ...
                    <div class="form-group col-12 list-group-item">
                        ...
                        <center><h4><?php echo e($client->prenomClient); ?> <?php echo e($client->nomClient); ?></h4></center>
                    </div>
                    <div class="form-group col-6 list-group-item">
                        <label>Code: </label>
                        <?php echo e($client->codeClient); ?>

                    </div>
                    <div class="form-group col-6 list-group-item">
                        <label>Genre: </label>
                        <?php echo e($client->genreClient); ?>

                    </div>

                    <div class="form-group col-6 list-group-item">
                        <label>Adresse: </label>
                        <?php echo e($client->adresseClient); ?>

                    </div>
                    <div class="form-group col-6 list-group-item">
                        <label>Ville: </label>
                        <?php echo e($client->villeClient); ?>

                    </div>
                    <div class="form-group col-6 list-group-item">
                        <label>Province: </label>
                        <?php echo e($client->provinceClient); ?>

                    </div>
                    <div class="form-group col-6list-group-item">
                        <label>Pays: </label>
                        <?php echo e($client->paysClient); ?>

                    </div>

                    <div class="form-group col-6 list-group-item">
                        <label>Titre: </label>
                        <?php echo e($client->titreClient); ?>
                    ...
                    <div class="form-group col-6 list-group-item">
                        ...
                        <?php echo e($client->courriel); ?>

                    </div>
                    <div class="form-group col-6 list-group-item">
                        <label>Site web: </label>
                        <?php echo e($client->siteweb); ?>

                    </div>
                    <div class="form-group col-6 list-group-item">
                        <label>Profession: </label>
                        <?php echo e($client->professionClient); ?>
                    ...
                    <div class="form-group col-6 list-group-item">
                        ...
                        <?php echo e($client->domaineActivite); ?>

                    </div>
                    <div class="form-group col-6 list-group-item">
                        <label>Terme de paiement: </label>
                        <?php echo e($client->termepaiement); ?> Jours
                    </div>
                    <div class="form-group col-6 list-group-item">
                        <label>Type du Client: </label>
                        <?php echo e($client->typeclient); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\BESOFTWAIRE\resources\views/clients/show.blade.php ENDPATH**/ ?>