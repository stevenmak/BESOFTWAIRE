...
<?php echo Form::open(array('route' => 'devis.store','method'=>'POST')); ?>
    ...
    <div class="row">
        ...
        <div class="col-4 text-right">
            ...
            <div class="text-highlight"> <?php echo Form::text('devis[reference]', null, array('placeholder' => 'Reference devis','class' => 'form-control')); ?></div>
            <div class="text-sm"><?php echo Form::date('devis[datedevis]', \Carbon\Carbon::now(), array('class' => 'form-control')); ?></div>
            <div class="text-sm"><?php echo Form::text('devis[descriptiondevis]', null, array('placeholder' => 'Description devis','class' => 'form-control')); ?></div>
            <td class="flex"><h6>Maitre d'Ouvrage:  <?php echo Form::select('devis[client_id]',  App\Clients::select(DB::raw("CONCAT(prenomClient,' ', nomClient) AS nomComplet, id"))
    ...
    <div class="padding">
        <div class="col-12">
            <h2 class="text-center">PROJET:
                <?php echo Form::select('devis[projet_id]', App\Projets::pluck('nomProjet','id') , null, array('class' => 'form-control')); ?></h2>
        </div>
    </div>
    <table class="table table-theme table-rows v-middle" id="tab_logic">
        ...
        <tbody>
          <tr id='addr0'>
            ...
            <td> <?php echo Form::select('materiaux_id[]', App\Materiels::pluck('designation','id') , null, array('class' => 'form-control')); ?></td>
    ...
    <div class="row py-3">
        <div class="col-md-3 py-2">
            ...
            <div><?php echo Form::select('devis[service_id]', App\Services::pluck('designation','id') , null, array('class' => 'form-control')); ?></h2></div>
        </div>
        <div class="col-md-3 py-2">
            <div class="text-muted">Etat d'un devis</div>
            <div><?php echo Form::select('devis[etatdevis]', DB::table('approbation')->pluck('intitule','intitule') , null, array('class' => 'form-control')); ?></div>
        </div>
        <div class="col-md-3 py-2">
            <div class="text-muted">Concerne la tache de:</div>
            <div><?php echo Form::select('devis[tacheDevis]', DB::table('taches')->pluck('designation','designation') , null, array('class' => 'form-control')); ?></div>
        </div>
        <div class="col-md-3 py-2 text-right">
            <input type="hidden" class="form-control"  name="devis[users_id]" required value="<?php echo e(auth()->user()->id); ?>">
        </div>
    </div>
    ...
    <script type="text/javascript" src="<?php echo e(asset('libs/jquery/dist/jquery.min.js')); ?>" >
    <script type="text/javascript" src="<?php echo e(asset('js/custom.js')); ?>" >
    </script>
<?php $__env->stopSection(); ?>


<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\BESOFTWAIRE\resources\views/devis/create.blade.php ENDPATH**/ ?>