...
<?php $__env->startSection('content'); ?>
    <div class="col-lg-12">
        <div class="card">
            ...
            <?php endif; ?>
            <div class="card-body">
                <?php echo Form::open(array('route' => 'depenses.store','method'=>'POST')); ?>
                ...
                <div class="row row-sm">
                    ...
                    <div class="form-group col-6">
                        ...
                        <?php echo e(Form::date('datedepense', null, ['class' => 'form-control', 'id'=>'datetimepicker'])); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\BESOFTWAIRE\resources\views/depenses/create.blade.php ENDPATH**/ ?>