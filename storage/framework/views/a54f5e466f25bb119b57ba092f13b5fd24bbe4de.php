<?php $__env->startSection('title', 'Showpaiements'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <div class="">
                    <h3 class="card-title text-center">BON D'ENTREE CAISSE N° <?php echo e($paiements->reference); ?></h3>
                    <hr>
                        ...
                        <h5 class="card-text">Montant    : <?php echo e(number_format($paiements->montant,2, ',',' ')); ?> $</h5>
                        
                                        </td>
                                        <td class="text-right"><h5 class="card-text">POUR LE COMPTE DE :
                        <?php echo e($prenomclient=DB::table('clients')->join('projets','clients.id','=','projets.client_id')
                        ->select('clients.prenomClient')->where('projets.id',$paiements->projet_id)->value('prenomClient')); ?> <?php echo e($nomclient=DB::table('clients')->join('projets','clients.id','=','projets.client_id')
                        ->select('clients.nomClient')->where('projets.id',$paiements->projet_id)->value('nomClient')); ?>

                    </h5>
                <h5 class="card-text">
                    Projet : <?php echo e($nomprojet=App\projets::select('nomProjet')->where('id',$paiements->projet_id)->value('nomProjet')); ?>

                </h5></td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <h5 class="card-title">Montant (en lettres):<em> <?php echo e(NumConvert::word($paiements->montant)); ?> dollars.</em></h5>
                                            <h5 class="card-text">Motif paiement : <?php echo e($paiements->description); ?></h5>
                                    </tr>
                                    <tr>
                                        <td>
                                            <div class="text-sm text-muted">                    
                                             ...
                                             <div class="text-sm text-muted">                    
                                                ...
                                                <?php echo e($prenomagent=DB::table('agents')->select('prenom')->where('agents.id',$idagent)->value('prenom')); ?>

                                                <?php echo e($nomagent=DB::table('agents')->select('nom')->where('agents.id',$idagent)->value('nom')); ?>

                                            </div>
                                            <div class="text-sm text-muted">                    
                                                Date : <?php echo e($paiements->datepaiement); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\BESOFTWAIRE\resources\views/paiements/show.blade.php ENDPATH**/ ?>