<?php $__env->startSection('title', 'ModifierAgent'); ?>
    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <?php endif; ?>
                <?php echo Form::model($agents, ['method' => 'PATCH','route' => ['agents.update', $agents->id]]); ?>
                ...
                <div class="row row-sm">
                    ...
                    <div class="form-group col-6">
                        <label>Genre</label>
                        <?php echo Form::text('genre', null, array('placeholder' => 'Genre','class' => 'form-control')); ?>
                    ...
                    <div class="form-group col-6">
                        ...
                        <?php echo Form::text('profession', null, array('placeholder' => 'Profession','class' => 'form-control')); ?>
                    ...
                    <div class="form-group col-6">
                        ...
                        <?php echo Form::text('etatCivil', null, array('placeholder' => 'Etat Civil','class' => 'form-control')); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\BESOFTWAIRE\resources\views/agents/edit.blade.php ENDPATH**/ ?>